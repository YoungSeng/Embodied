...
export EVAL_INFERENCE_WORKERS_PER_GPU
...
printf '%-28s: %s\n' \
  ...
  "EVAL_INFERENCE_WORKERS/GPU" "${EVAL_INFERENCE_WORKERS_PER_GPU}" \
...
run_evaluation() {
  ...
  local -a command=(
    ...
    --eval-inference-workers-per-gpu "${EVAL_INFERENCE_WORKERS_PER_GPU}"
