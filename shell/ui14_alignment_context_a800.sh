...
export UI14_ALIGNMENT_DATA_ROOT="${UI14_ALIGNMENT_DATA_ROOT:-${WORKSPACE}/gui_data/ui14_alignment_context_v1}"
export UI14_ALIGNMENT_PARENT_DATA_ROOT="${UI14_ALIGNMENT_PARENT_DATA_ROOT:-${WORKSPACE}/gui_data/ui14_cpt9000_neg11_v1}"
